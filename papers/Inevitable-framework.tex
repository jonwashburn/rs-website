...
% \usepackage{times} % removed to avoid courier font dependency
\usepackage{lmodern}
\usepackage{helvet}
\usepackage[T1]{fontenc}
% \usepackage{courier} % removed to avoid missing pcrr7t font
...
% unified definition provided once near preamble
