...
\usepackage[numbers]{natbib} % numeric citations for minimal build
\usepackage{listings}
\usepackage{verbatim}
...
\bibitem{li2018} Li, P., et al. 2018, \textit{Astronomy \& Astrophysics}, 615, A3. A comprehensive catalog of dark matter halo models for SPARC galaxies.
