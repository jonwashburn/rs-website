...
% \usepackage{physics} % disabled to avoid dependency on missing package
\usepackage{graphicx}
\usepackage{hyperref}
% \usepackage{cleveref} % disabled for minimal build
% \usepackage{enumitem} % disabled for minimal build
\usepackage{tikz}
\usepackage{listings}
\usepackage{color}
% \usepackage{soul}
